...
CREATE TABLE `iwater_archive_device` (
  `id` bigint NOT NULL,
  `device_name1` varchar(255) DEFAULT NULL,
  `serial_no1` varchar(255) DEFAULT NULL,
  `device_name2` varchar(255) DEFAULT NULL,
  `serial_no2` varchar(255) DEFAULT NULL,
  `device_name3` varchar(255) DEFAULT NULL,
  `serial_no3` varchar(255) DEFAULT NULL,
...
CREATE TABLE `iwater_archive_site` (
  `id` bigint NOT NULL,
  ...
  `token_verified` tinyint(1) NOT NULL,
  `status` tinyint(1) NOT NULL,
  `alerts` smallint NOT NULL,
  `created` date NOT NULL,
  `is_treatment_unit` tinyint(1) NOT NULL,
  `is_dispensing_unit` tinyint(1) NOT NULL,
  `otp` varchar(4) DEFAULT NULL,
  `otp_created` datetime(6) DEFAULT NULL,
...
CREATE TABLE `iwater_archive_site_permissions` (
  `id` bigint NOT NULL,
  `created` date NOT NULL,
  `site_id` bigint DEFAULT NULL,
...
CREATE TABLE `iwater_order` (
  `id` bigint NOT NULL,
  `amount` double NOT NULL,
  `payment_status` varchar(254) NOT NULL,
  `provider_order_id` varchar(40) NOT NULL,
  `payment_id` varchar(36) NOT NULL,
  `signature_id` varchar(128) NOT NULL,
  `paid_on` datetime(6) DEFAULT NULL,
  `paid_user_id` bigint DEFAULT NULL,
  `company_id` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `iwater_price` (
  `id` bigint NOT NULL,
  `dispensing_price` varchar(255) NOT NULL,
  `treatment_price` varchar(255) NOT NULL,
  `dispensing_tax` varchar(255) NOT NULL,
  `treatment_tax` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `iwater_price` (`id`, `dispensing_price`, `treatment_price`, `dispensing_tax`, `treatment_tax`) VALUES
(1, '1000', '1200', '10', '12');
...
CREATE TABLE `iwater_site_permissions` (
  `id` bigint NOT NULL,
  `created` date NOT NULL,
  `site_id` bigint DEFAULT NULL,
  `user_id` bigint DEFAULT NULL
...
CREATE TABLE `iwater_subscription` (
  `id` bigint NOT NULL,
  `is_treatment_unit` tinyint(1) NOT NULL,
  `is_dispensing_unit` tinyint(1) NOT NULL,
  `created` date NOT NULL,
  ...
  `no_of_sites` smallint NOT NULL,
  `assigned_sites` smallint NOT NULL,
  `unassigned_sites` smallint NOT NULL,
  `last_paid` decimal(10,2) NOT NULL,
  `total_paid` decimal(10,2) NOT NULL,
  `data_transfer_volume` bigint NOT NULL,
  `no_of_actions` bigint NOT NULL,
...
CREATE TABLE `iwater_user` (
  ...
  `token_created` datetime(6) DEFAULT NULL,
  `is_super_admin` tinyint(1) NOT NULL,
  `invite_link_expired` tinyint(1) NOT NULL,
  `added_by_id` bigint DEFAULT NULL,
  `otp` varchar(6) DEFAULT NULL,
  `otp_created` datetime(6) DEFAULT NULL,
  `phone_verified` tinyint(1) NOT NULL,
  `invite_rejected` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `iwater_user_groups` (
  `id` bigint NOT NULL,
  `user_id` bigint NOT NULL,
  `group_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `iwater_user_user_permissions` (
  `id` bigint NOT NULL,
  `user_id` bigint NOT NULL,
  `permission_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
