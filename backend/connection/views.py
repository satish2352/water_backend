...
class MqttClient:
    ...
    def otp_handler(self, client, userdata, message):
        try:
            ...
            print("Error in otp handler function ",err)
        ...
        try:
            ...
            if topic_from_broker != "wc1/v1/OTP":
                ...
                if dict_str.startswith("{'") and dict_str.endswith("'}") or 'version' not in dict_str:
                    ...
                    dinfo = device_info.objects.filter(Device_id = device_id).first()
            ...
            print("Error in ctrl_motr_handler function ",err)
