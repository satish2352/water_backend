...
def send_otp(request):
    ...
    if request.method == 'POST':
        ...
        print("send_otp request", request.data)
        ...
        try:
            existing_site = Site.objects.get(company_id=company_id, site_name=site_name)
        ...
        with transaction.atomic():
            try:
                site_obj = Site.objects.filter(company_id=company_id, site_name=site_name).first()
